...
Things I'd like to include in the first half of this section:

\begin{itemize}
    \item Discussion of why someone might not report, fueled by \citeA{allen_reporting_2007} and \citeA{du_mont_role_2003} as well as any other papers I find about this
    \item Pull that discussion into a more formal discussion of the costs that one faces in reporting 
\end{itemize}
