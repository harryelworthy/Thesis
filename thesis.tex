...
There are many good reasons for policymakers to seek to increase the proportion of sexual assaults that are reported. Victims of rape that report the crime to the police are 9 times more likely to receive medical care than those that do not. Primarily, sexual assaults that are not reported w

From Sable: "There are a number of reasons to encourage survivors to report assaults. For society, the major benefit would be to heighten awareness of the consequences of the crime, which might result in preventing rape or sexual asasult. For survivors, the major benefit may be an increased opportunity to receive the medical and psychological first aid to assist in recovering from an event with significant psychological and physical trauma."

According to Fisher, "fewer than 5\% of attempted or completed sexual assault against college age women are reported to law enforcement. 66\% of victims tell friends but not family or school officials." Based on a phone survey to college-age women in 1996.

Abel: finds that non-incarcerated rapists have high recidivism rates, suggesting that unreported rapes pose a serious threat to others.

Bachmann et al: finds that "men's propensity to commit sexual assault was significantly decreased by the threat of formal sanctions, such as arrest or university dismissal." 

Antunes and Hunt also find that would-be rapists are detered by the threat of formal sanctions.

Bachmann 1998: "Obviously, reporting an incident of rape to the police is a necessary condition for any police response." "An unreported incident of rape eliminates the possibility that an offender will be arrested or convicted. This may, in turn, reduce the perceived likelihood that rape and sexual assault, in general, will be punished. 

From Resnick: "One in five victims reported an adult rape to police or other authorities; these women were nine times more likely to receive medical care than those who did not. Public health efforts are needed to increase the proportion of rape victims who receive immediate post-rape medical care."

From Greenfield: In a household survey in 1995, 260300 completed or attempted rapes were reported, of which only a third were reported to the police. This initial number still is likely an underestimate, as although a household survey is easier to report to than the police, there are undoubtedly still non-reporters.
...
\input{figures/iv_robustness.tex}
\end{table}
