...
The decision to report can be considered as a probabilistic decision that factors in both costs and benefits of reporting \cite{allen_reporting_2007}. 
...
\begin{itemize}
    ...
    \item Also discuss possible expectations about subgroups. 
\end{itemize}
